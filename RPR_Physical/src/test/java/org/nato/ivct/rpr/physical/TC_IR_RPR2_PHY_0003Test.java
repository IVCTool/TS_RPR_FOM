...
public class TC_IR_RPR2_PHY_0003Test {

    public static final Logger log = LoggerFactory.getLogger(TC_IR_RPR2_PHY_0003Test.class);
    RTIambassador rtiAmbassador = null;

    @Test
    void performTest() {
        TC_IR_RPR2_PHY_0003 tc = new TC_IR_RPR2_PHY_0003();
